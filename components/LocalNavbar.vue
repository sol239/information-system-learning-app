  ...
  <div class="flex items-center w-full justify-between">
    ...
    <div class="flex items-center">
      ...
      <UPopover v-model:open="tasksPopoverOpen" arrow>
        <UButton icon="i-lucide-list-todo" :label="selectedTaskStore.selectedTask?.title || $t('tasks')" color="primary" variant="subtle" />
      ...
      <UButton
        :icon="highlightStore.isHighlightMode ? 'i-lucide-lightbulb' : 'i-lucide-lightbulb-off'"
      ...
      <UPopover v-model:open="exitPopoverOpen" arrow>
        <UButton icon="i-heroicons-arrow-right-on-rectangle" :label="$t('exit_system')" color="red" variant="subtle" style="margin-left: 10px" />

        <template #content>
          <UCard>
            <div class="flex flex-col gap-2">
              <UButton :label="$t('leave_system')" color="red" variant="outline" icon="i-heroicons-arrow-right-on-rectangle"
                @click="leaveSystem" />
              <!-- TODO: Implement saving -->
              <UButton disabled :label="$t('leave_and_save')" color="yellow" variant="outline" icon="i-heroicons-document-check"
                @click="leaveAndSave" />
              <UButton :label="$t('stay_in_system')" color="neutral" variant="outline" icon="i-heroicons-x-mark"
                @click="stayInSystem" />
            </div>
          </UCard>
        </template>
